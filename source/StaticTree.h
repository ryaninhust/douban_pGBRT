...
class StaticTree {
        public:
                ...
                void clear();
                void startNextLayer();
                void findBestLocalSplits(FeatureData* data, int numtree);
        ...
        private:
                ...
                void updateBestSplits(FeatureData* data, int f, int numtree);
...
void StaticTree::findBestLocalSplits(FeatureData* data, int numtree) {
        ...
        for (int f=0; f<data->getNumFeatures(); f++) {
                updateBestSplits(data, f, numtree);
        }       
}

// REVISE
void StaticTree::updateBestSplits(FeatureData* data, int f, int numtree) {
